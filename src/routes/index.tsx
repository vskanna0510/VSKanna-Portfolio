...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "I'm a full-stack and AI engineer at SSN. This site has my projects, GitHub stats, and contact info." },
      { property: "og:title", content: "V S Kanna — Full Stack & AI Engineer" },
      { property: "og:description", content: "Full-stack and AI engineer. M.E. CSE at SSN. Projects, hackathons, and contact." },
