...
export function Hero() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen overflow-x-hidden overflow-y-visible">
      ...
      <motion.div
        style={{ y, opacity }}
        className="relative z-10 mx-auto grid min-h-screen max-w-7xl grid-cols-1 items-center gap-8 px-6 pt-28 md:grid-cols-[1.1fr_1fr] md:gap-12 md:pt-24"
      >
        {/* LEFT: text */}
        <div className="text-center md:text-left">
          ...
          >
            M.E. Computer Science at{" "}
            <span className="text-foreground">SSN College of Engineering</span> · CGPA{" "}
            <span className="text-foreground">9.09/10</span>. I build{" "}
            <span className="text-foreground">web apps</span>,{" "}
            <span className="text-foreground">REST APIs</span>, and{" "}
            <span className="text-foreground">AI features</span> that people actually use.
          </motion.p>
          ...
          >
            <a
              href="#projects"
              className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full px-6 py-3 text-sm font-semibold text-primary-foreground transition-transform hover:scale-[1.03] animate-gradient"
            ...
            <a
              href="#github"
              className="glass inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold hover:border-[var(--coral)]/60"
            >
              <Github className="h-4 w-4 text-[var(--coral)]" /> GitHub
            </a>
            <a
              href="#ai-lab"
              className="glass inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold hover:border-[var(--amber)]/60"
            >
              <FlaskConical className="h-4 w-4 text-[var(--amber)]" /> AI Lab
            </a>
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full border border-white/10 px-6 py-3 text-sm font-semibold hover:border-white/30"
            >
...
const JOURNEY = [
  {
    icon: GraduationCap,
    title: "B.Tech IT, Chennai Institute of Technology",
    year: "2021 – 2025",
    text: "Information Technology · CGPA 8.69/10. Learned web dev, DSA, and how to build real software.",
  },
  {
    icon: Briefcase,
    title: "Backend Engineer Intern · NKINFYX (FYXIN)",
    year: "2024",
    text: "Built 10+ ERP modules with REST APIs, cut query time by 35%, and fixed 50+ bugs over 6 sprints.",
  },
  {
    icon: Trophy,
    title: "President · TROJANS, CIT",
    year: "Sep 2024 – Apr 2025",
    text: "Ran 12 committees and a national symposium with 2,500 participants.",
  },
  {
    icon: Brain,
    title: "Multimodal AI research",
    year: "Aug – Sep 2025",
    text: "Combined BERT, ResNet, and audio features into one mental-health risk model — 87% accuracy.",
  },
  {
    icon: GraduationCap,
    title: "M.E. Computer Science, SSN College of Engineering",
    year: "Jul 2025 → Present",
    text: "CGPA 9.09/10 · focusing on deep learning, NLP, and multimodal systems.",
  },
  {
    icon: Rocket,
    title: "Looking for full-stack / backend roles",
    year: "2026 →",
    text: "Open to teams building useful products in Chennai, hybrid, or remote.",
  },
];
  ...
  return (
    <section id="about" className="relative mx-auto max-w-7xl px-6 py-32">
      <SectionHeader
        ...
        title={
          <>
            How I got from <span className="text-gradient">CIT</span> to{" "}
            <span className="text-gradient">SSN</span>
          </>
        }
      ...
      <div className="relative mt-20">
        ...
        {JOURNEY.map((j, i) => {
          ...
          return (
            ...
            >
              <div
                className="absolute -left-1 top-4 grid h-9 w-9 place-items-center rounded-full glow-coral md:left-auto md:-translate-x-1/2"
                style={
                  {
                    background: "var(--gradient-brand)",
                    [left ? "right" : "left"]: "-48px",
...
const SKILLS = [
  {
    ...
    color: "var(--coral)",
    icon: Code2,
    items: ["Python", "JavaScript (ES6+)", "Java", "C", "C++", "R", "PHP", "HTML5", "CSS3"],
  },
  {
    cat: "Frontend",
    color: "var(--amber)",
    icon: Layers,
    items: ["React.js", "Next.js", "Vue.js", "Tailwind CSS", "Responsive Design", "Web Animations"],
  },
  {
    cat: "Backend",
    color: "var(--pink)",
    icon: ServerCog,
    items: ["Node.js", "Express.js", "Spring Boot", "REST APIs", "GraphQL", "Microservices"],
  },
  {
    cat: "Databases & Big Data",
    color: "var(--coral)",
    icon: Database,
    items: ["MongoDB", "PostgreSQL", "MySQL", "Cassandra", "Neo4j", "Kafka", "Hadoop", "Spark"],
  },
  {
    cat: "AI / ML",
    color: "var(--amber)",
    icon: Brain,
    items: ["TensorFlow", "PyTorch", "BERT", "CNNs", "GANs", "NLP", "Fine-Tuning", "OpenCV"],
  },
  {
    cat: "DevOps & Tools",
    color: "var(--pink)",
    icon: Cpu,
    items: ["Git", "Docker", "CI/CD", "Linux", "Postman", "VS Code", "Agile/Scrum", "SDN"],
  },
];
  ...
  return (
    <section id="skills" className="relative mx-auto max-w-7xl px-6 py-32">
      <SectionHeader
        ...
        sub="Languages and tools I've used in internships, research, and hackathons."
      />
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {SKILLS.map((s, i) => {
          ...
          return (
            ...
            >
              <div
                className="absolute -right-12 -top-12 h-40 w-40 rounded-full opacity-20 blur-3xl transition-opacity group-hover:opacity-60"
              ...
              <div className="relative mt-5 flex flex-wrap gap-2">
                {s.items.map((it) => (
                  <span
                    key={it}
                    className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-1 text-xs text-foreground/85 transition-colors hover:border-white/30 hover:text-foreground"
                  >
                    {it}
                  </span>
                ))}
  ...
  return (
    <section id="projects" className="relative mx-auto max-w-7xl px-6 py-32">
      <SectionHeader
        ...
        sub="Real problems, with numbers where I have them."
      />
          ...
          {list.map((p, i) => (
            ...
            >
              <div
                ...
                style={{
                  background: `radial-gradient(circle at 30% 0%, ${p.color}33, transparent 60%)`,
                }}
              />
              <div className="relative">
                <div
                  className="mb-6 flex aspect-[16/10] items-center justify-center overflow-hidden rounded-xl border border-white/10"
                  style={{
                    background: `linear-gradient(135deg, ${p.color}22, transparent 70%), radial-gradient(circle at 70% 70%, ${p.color}33, transparent 50%)`,
                  }}
                >
                  <div
                    className="font-mono text-3xl font-bold opacity-80"
                    style={{ color: p.color }}
                  >
                ...
                <div className="mt-4 flex flex-wrap gap-1.5">
                  {p.stack.map((s) => (
                    <span
                      key={s}
                      className="rounded border border-white/10 bg-white/[0.03] px-2 py-0.5 text-[10px] font-mono text-muted-foreground"
                    >
                      {s}
                    </span>
                  ))}
                ...
                <div className="mt-5 flex gap-3 text-xs">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-foreground/90 hover:text-[var(--coral)]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-foreground/90 hover:text-[var(--amber)]"
                  >
...
const AI_PROJECTS = [
  {
    title: "Deepfake Detection (CNN/GAN)",
    desc: "94% accuracy on insurance images, under 300ms per run.",
    tags: ["TensorFlow", "OpenCV", "Flask"],
  },
  {
    title: "Multimodal Risk Detection",
    desc: "BERT + ResNet + audio combined — 87% accuracy.",
    tags: ["PyTorch", "BERT", "Gradio"],
  },
  {
    title: "Transfer Learning Pipelines",
    desc: "Reusable scripts for training, testing, and deployment.",
    tags: ["TensorFlow", "PyTorch"],
  },
  {
    title: "NLP Experiments",
    desc: "Fine-tuned transformers on domain-specific datasets.",
  ...
  return (
    <section id="ai-lab" className="relative overflow-hidden py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <SectionHeader
          kicker="AI work"
          title={<>ML projects and a small demo</>}
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              <div className="flex items-center gap-2 text-xs uppercase tracking-wider text-muted-foreground">
                <span className="h-2 w-2 animate-pulse rounded-full bg-[var(--coral)]" /> Model view
                · live
              </div>
            ...
            <div className="mt-4 grid grid-cols-3 gap-3 text-center text-xs">
              <div className="rounded-lg border border-white/10 p-2">
                <div className="font-mono text-[var(--coral)]">4</div>
                <div className="text-muted-foreground">Input types</div>
              </div>
              <div className="rounded-lg border border-white/10 p-2">
                <div className="font-mono text-[var(--amber)]">87%</div>
                <div className="text-muted-foreground">Model accuracy</div>
              </div>
              <div className="rounded-lg border border-white/10 p-2">
                <div className="font-mono text-[var(--pink)]">{Math.round(density)}</div>
            ...
            >
              ...
              <div className="relative mt-3 flex flex-wrap gap-1.5">
                {p.tags.map((t) => (
                  <span
                    key={t}
                    className="rounded border border-[var(--amber)]/30 bg-[var(--amber)]/5 px-2 py-0.5 font-mono text-[10px] text-[var(--amber)]"
                  >
                    {t}
                  </span>
                ))}
...
const XP = [
  {
    ...
    org: "NKINFYX GROUPS Pvt. Ltd. (FYXIN Division), Pondicherry",
    date: "2024",
    text: "Built 10+ ERP modules, cut query time by 35%, fixed 50+ bugs, and hit every sprint deadline across 6 sprints.",
  },
  {
    role: "President — TROJANS",
    org: "Chennai Institute of Technology",
    date: "Sep 2024 – Apr 2025",
    text: "Organized 12 committees and a national symposium with 2,500 participants.",
  },
  {
    role: "M.E. Computer Science & Engineering",
    org: "SSN College of Engineering, Chennai",
    date: "Jul 2025 → Present",
    text: "CGPA 9.09/10 · deep learning, NLP, and multimodal systems.",
  },
  {
    role: "B.Tech Information Technology",
    org: "Chennai Institute of Technology",
    date: "Jun 2021 – May 2025",
    text: "CGPA 8.69/10 · DSA, web development, distributed systems, and AI basics.",
  },
];
    ...
    <section id="experience" className="relative mx-auto max-w-7xl px-6 py-32">
      ...
      <div className="relative">
        ...
        {XP.map((x, i) => (
          ...
          >
            <div
              className="absolute left-0 top-2 grid h-7 w-7 place-items-center rounded-full glow-coral"
...
const TROPHIES = [
  {
    icon: Trophy,
    title: "Top 8 — IIT Madras Hackathon",
    text: "Made it to the final round nationally.",
    color: "var(--coral)",
  },
  {
    icon: Star,
    title: "Top 9 — IEEE Madras 24h Hackathon",
    text: "Built a working solution in 24 hours.",
    color: "var(--amber)",
  },
  {
    icon: Zap,
    title: "2nd Runner-Up — SIH 2022",
    text: "Smart India Hackathon — placed among the top teams.",
    color: "var(--pink)",
  },
  {
    icon: Brain,
    title: "Top 20 — Build-A-Thon 2023",
    text: "Recognized for a solid, practical build.",
    color: "var(--coral)",
  },
  {
    icon: Rocket,
    title: "TCS & Hero Campus Challenges",
    text: "Completed industry coding challenges in 2022.",
    color: "var(--amber)",
  },
  {
    icon: Globe,
    title: "1000+ SkillRack · 300+ LeetCode",
    text: "Lots of practice on data structures and algorithms.",
    color: "var(--pink)",
  },
];
    ...
    <section id="achievements" className="relative mx-auto max-w-7xl px-6 py-32">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          >
            <div className="text-[10px] uppercase tracking-wider text-[var(--amber)]">
              Certification
            </div>
...
const STATIC_COMMANDS: Record<string, string> = {
  ...
  about:
    "I'm V S Kanna — M.E. CSE at SSN. Full-stack and AI engineer. Open to backend and full-stack roles.",
  skills: "Languages, frontend, backend, databases, AI/ML, DevOps — see the Skills section.",
  contact: `${EMAIL} · ${PHONE} · ${LINKEDIN}`,
  achievements:
    "IIT Madras Top 8 · IEEE Madras Top 9 · SIH 2nd Runner-Up · 1000+ SkillRack · 300+ LeetCode",
        ...
        >
          {lines.map((l, i) => (
            <div key={i} className={l.t === "in" ? "text-foreground" : "text-muted-foreground"}>
              {l.t === "in" ? (
                <>
                  <span className="text-[var(--coral)]">kanna@os</span>:
                  <span className="text-[var(--amber)]">~</span>$ {l.v}
                </>
              ) : (
                l.v
              )}
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        >
          <p className="mb-6 text-sm text-muted-foreground">
            This opens your email app with your message pre-filled. You can also email me directly
            at{" "}
            <a
              href={`mailto:${EMAIL}`}
          ...
          >
            <AnimatePresence mode="wait">
              {sent ? (
                ...
                >
                  <Sparkles className="h-4 w-4" /> Opening your email app…
                </motion.span>
              ) : (
                <motion.span
                  key="send"
          ...
          {[
            ...
            return (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="glass group flex items-center gap-4 rounded-2xl p-5 transition-transform hover:-translate-y-1"
              >
                <div
  ...
  return (
    <header className="fixed inset-x-0 top-4 z-50 flex flex-col items-center px-4">
      <nav className="glass-frost flex w-full max-w-[95vw] items-center gap-1 rounded-full px-2 py-1.5 md:w-auto">
        <Link
          to="/"
          className="mr-2 flex shrink-0 items-center gap-2 rounded-full px-3 py-1.5 text-sm font-semibold"
        >
          <span
        ...
        >
          <span className="relative block h-3 w-4">
            <span
              className={`absolute left-0 top-0 h-[2px] w-full bg-current transition-transform ${open ? "translate-y-[5px] rotate-45" : ""}`}
            />
            <span
              className={`absolute left-0 top-[5px] h-[2px] w-full bg-current transition-opacity ${open ? "opacity-0" : "opacity-100"}`}
            />
            <span
              className={`absolute left-0 top-[10px] h-[2px] w-full bg-current transition-transform ${open ? "-translate-y-[5px] -rotate-45" : ""}`}
            />
          </span>
        </button>
        <Link
          to="/contact"
          className="ml-2 hidden shrink-0 items-center gap-1 rounded-full px-3 py-1.5 text-xs font-semibold text-background animate-gradient md:inline-flex"
          style={{ backgroundImage: "var(--gradient-brand)" }}
        >
...
export function ScrollProgress() {
  ...
  return (
    <motion.div
      style={{ scaleX: sx, transformOrigin: "0% 50%", backgroundImage: "var(--gradient-brand)" }}
    ...
    <footer className="relative border-t border-white/10 px-6 py-10">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 sm:flex-row">
        <div className="font-mono text-xs text-muted-foreground">
          © {new Date().getFullYear()} V S Kanna
        </div>
